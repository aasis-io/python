...
with open('ipo_data.json','w') as f: #automatically closes the file after use
    json.dump(table_data, f, indent=2) #writes the data to ipo_data.json froom table_data
